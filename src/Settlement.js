...
export default class PurchaseTicket extends Component {
  ...
  constructor (props) {
    ...
    super(props);
     ...
     console.log(" props " + this.props.auctionId + " " + this.props.auctioneerId);
      ...
      AuctionFactory.deployed().then(function(factInstance) {
        factInstance.getEscrow.call(me.props.auctionId).then(function(escId) {
            ...
            pEscrow.PaymentRelease().watch ( (err, response) => {  
                  ...
                  console.log('Funds of tickets for buyer : ' + response.args.buyer + " released to auctioneer " + auctioneerId);
                });
            ...
            pEscrow.PaymentReleaseFail().watch ( (err, response) => {  
                  ...
                  console.log('Relase Funds failed of tickets for buyer : ' + response.args.buyer + " with total price " + response.args.price);
                });
              ...
              <div className="table-responsive">
                <table className="table table-bordered" id="dataTable" width="100%" cellSpacing="0">
                  <tbody>
                    ...
                    <tr>
                      <td>Buyer Address</td>
                      <td><input className="form-control" ref="tktReceiptId"  defaultValue="0x3ad78130DCff93d6c942c37aA45F0A004A0Ffe0C" placeholder="Buyer Address" /></td>
                    </tr>
                  </tbody>
                </table>                
              </div>
